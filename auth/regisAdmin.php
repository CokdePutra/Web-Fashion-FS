...
<body
    ...
    <div class="max-w-sm w-full m-10">
        ...
        <form action="proses_regisAdmin.php" method="POST" class="p-8 rounded-xl shadow-lg" style="background-color: #C9DAF4">
            <input
                type="text"
                placeholder="Nama"
                name="nama"
            ...
            onclick="alert('Akun sudah dibuat. Silahkan Masuk');"></a> -->
                    Daftar
                </button>
            </div>
        </form>
